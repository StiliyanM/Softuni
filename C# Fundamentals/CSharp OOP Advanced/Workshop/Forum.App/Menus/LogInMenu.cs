namespace Forum.App.Menus
{
    ...
    public class LogInMenu : Menu
    {
        ...
        public LogInMenu
            (ILabelFactory labelFactory, ICommandFactory commandFactory, 
		...
		public override IMenu ExecuteCommand()
		{
            ...
            {
                int left = this.CurrentOption.Position.Left + 1;
                int top = this.CurrentOption.Position.Top;

                string fieldInput = " " + this.forumReader.ReadLine(left, top);

                this.Buttons[this.currentIndex] = this.labelFactory
                    .CreateButton(fieldInput,
