...
namespace Forum.Data
{
    public class DataMapper
    {
        ...
        private static readonly Dictionary<string, string> config = LoadConfig(DATA_PATH + CONFIG_PATH);
